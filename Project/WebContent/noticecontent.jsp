...
<table width="500" border="1" cellspacing="0" cellpadding="0"  bgcolor="#e0ffff" align="center">  
  ...
  <tr>
    ...
    <pre>${article.n_content}</pre></td>
  </tr>
  <tr height="30">
    <td colspan="4" bgcolor="#b0e0e6" align="right" >
	  <input type="button" value="글수정" 
       onclick="document.location.href='/Project/updateNoticeForm.do?n_num=${article.n_num}&pageNum=${pageNum}'">
	   &nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="button" value="글삭제" 
       onclick="document.location.href='/Project/deleteNoticeForm.do?n_num=${article.n_num}&pageNum=${pageNum}'">
	   &nbsp;&nbsp;&nbsp;&nbsp;
<%-- 	   
 ...
 --%>	   
       ...
       onclick="document.location.href='/Project/notice.do?pageNum=${pageNum}'">
    </td>
  </tr>
</table>    
</form>      
