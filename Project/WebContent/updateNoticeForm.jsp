                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                            ...
                            <form method="post" name="updateNoticeform" action="/Project/updateNoticePro.do?pageNum=${pageNum}" onsubmit="return writeSave()"><!-- <form action="#" method="post" id="contact-form"> -->
                            <input type="hidden" name="n_num" value="${article.n_num}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>내용</label>
                                        <textarea class="form-control" rows="6" id="contactmessage" name="n_content" placeholder="내용을 입력해주세요." required>${article.n_content}</textarea>
                                    </div><!-- End .col-md-12 -->
                                </div><!-- End .row -->
                                ...
                                <input type="button" class="btn btn-custom min-width" value="목록보기" onclick="document.location.href='/Project/notice.do?pageNum=${pageNum}'">
                            </form>
                        </div><!-- End .col-md-8 -->
