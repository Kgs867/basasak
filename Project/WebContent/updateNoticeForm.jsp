...
<center><b>글수정</b>
<br>
<form method="post" name="writeNoticeform" action="/Project/updateNoticePro.do?pageNum=${pageNum}" onsubmit="return writeSave()">
<table width="400" border="1" cellspacing="0" cellpadding="0"  bgcolor="#e0ffff" align="center">
  <tr>
    ...
    <td align="left" width="330">
       <input type="text" size="10" maxlength="10" name="a_id" value="${article.a_id}">
...
--%>
  <tr>
    ...
    <td align="left" width="330">
     <textarea name="n_content" rows="13" cols="40">${article.n_content}</textarea></td>
  </tr>
  <tr>
    <td  width="70"  bgcolor="#b0e0e6" align="center" >비밀번호</td>
    <td align="left" width="330" >
     	<input type="password" size="8" maxlength="12" name="n_pw">
	 </td>
  </tr>
  <tr>      
   <td colspan=2 bgcolor="#b0e0e6" align="center"> 
     ...
     <input type="button" value="목록보기" onclick="document.location.href='/Project/notice.do?pageNum=${pageNum}'">
   </td>
 </tr>
 </table>
</form>     
