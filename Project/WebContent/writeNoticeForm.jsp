...
<form method="post" name="writeNoticeform" action="/Project/writeNoticePro.do" onsubmit="return writeSave()">
...
<table width="400" border="1" cellspacing="0" cellpadding="0"  bgcolor="#e0ffff" align="center">
   <tr>
    <td align="right" colspan="2" bgcolor="#b0e0e6">
	    <a href="/Project/notice.do">글목록</a>
   </td>
   </tr>
   <tr>
    <td  width="70"  bgcolor="#b0e0e6" align="center">이 름</td>
    <td  width="330">
       <input type="text" size="10" maxlength="10" name="a_id"></td>
  </tr>
  <tr>
...
<tr>      
 <td colspan=2 bgcolor="#b0e0e6" align="center">
  ...
  <input type="button" value="목록보기" OnClick="window.location='/Project/notice.do'">
</td></tr></table>    
</form>      
