...
<%-- 								
 ...
 --%>
								...
								<!-- 글상세보기 부분  --> 
								<a href="/Project/qnacontent.do?q_num=${article.q_num}&pageNum=${pgList.currentPage}">${article.q_title}</a>
								<c:if test="${article.q_view>=20}">
							...
							<td align="center" width="150">${article.q_date}</td>
							<td align="center" width="50">${article.q_view}</td>
			...
			<c:forEach var="i" begin="${pgList.startPage}"
				...
				<a
					href="/Project/qna.do?pageNum=${i}&search=${search}&searchtext=${searchtext}">
