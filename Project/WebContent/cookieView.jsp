    ...
    <body>
        ...
        <div id="wrapper">
           <jsp:include page="header.jsp"></jsp:include>
            ...
            <div class="main">
                <div class="page-header largest parallax custom text-center" style="background-image:url(assets/images/bisciut.png)" data-0="background-position:50% 50%;" data-top-bottom="background-position:50% 100%">
...
<!-- 
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="product-desc">
                                ...
                                <img src="assets/images/cookie/상세설명.png" class="img-responsive pull-left" alt="오예스" style="padding-left:22%">
                                    ...
                                    <div class="product-top">
                                        ...
                                        <figure>
                                            <a href="http://localhost:8090/Project/cookieView.do?c_serial=b_02&pageNum=" title="Product Name">
                                                <img src="assets/images/cookie/biscuit_2.png" alt="오예스딸기" class="product-image">
                                                <img src="assets/images/cookie/biscuit_2.png" alt="오예스딸기" class="image-hover">
                                            </a>
                                        </figure>
                                    ...
                                    <span class="label discount">-50%</span>
                                        <figure>
                                            <a href="http://localhost:8090/Project/cookieView.do?c_serial=b_03&pageNum=" title="Product Name">
                                                <img src="assets/images/cookie/biscuit_3.png" alt="Product image" class="product-image">
                                            </a>
                                        </figure>
                                        <div class="product-action-container">
                                            <a href="#" class="btn product-add-btn" data-toggle="tooltip" title="Add to Cart"><i class="fa fa-shopping-cart"></i></a>
