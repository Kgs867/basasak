...
<%-- 								
 ...
 --%>
						...
						<table class="table table-bordered table-hover table-condensed">
							<tr>
								<td align="right" bgcolor="#fff">
									<input type="button" class="btn btn-custom min-width" value="글쓰기" OnClick="window.location='/Project/writeForm.do'">
								</td>
							</tr>
						</table>
			...
			<form name="test" align="center" action="/Project/review.do">
				<select name="search">
