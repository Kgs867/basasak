       ...
       <div id="wrapper">
            <header class="header header3 white sticky-header">
                <div class="header-top">
                    <div class="container-fluid">
                        ...
                        <div class="top-links pull-right" id="loginbar">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="header-center">
                            <a href="index.html" class="site-logo" title="Bold - Multipurpose Template">
                                <img src="assets/images/logo2.png" data-rjs="3" alt="Bold Logo">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="main-nav-container">
                            <ul class="nav navbar-nav navbar-nav-table">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">제품소개</a>
                                    <ul class="dropdown-menu col-lg-12" role="menu">
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle text-center" data-toggle="dropdown" role="button" aria-expanded="false" >비스켓</a>
                                        </li>
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle text-center" data-toggle="dropdown" role="button" aria-expanded="false" >스낵</a>
                                        </li>
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle text-center" data-toggle="dropdown" role="button" aria-expanded="false" >초코</a>
                                        </li>
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle text-center" data-toggle="dropdown" role="button" aria-expanded="false" >기타</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">회사소개</a>
                                    <ul class="dropdown-menu col-lg-12" role="menu">
            ...
            <div class="main">
                    ...
                    <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="slideoverup" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1200"  data-thumb="assets/images/homepages/index/slide1-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Bold">
                                ...
                                <!-- MAIN IMAGE -->
                                <img src="assets/images/homepages/index/MainTest.png"  alt="Slider bg 1"  data-bgposition="center center" data-duration="11000" data-ease="Linear.easeNone" class="rev-slidebg" data-no-retina>
                                <!-- LAYERS -->
                ...
                <div class="container-fluid text-center">
                    <h2 class="title custom text-center">이번주 HOT 상품!</h2>
                    <ul id="portfolio-filter">
                        <li class="active"><a href="#" data-filter="*">전체</a></li>
                        <li><a href="#" data-filter=".snack">스낵</a></li>
                        <li><a href="#" data-filter=".marketing">인기상품</a></li>
                        <li><a href="#" data-filter=".video">이벤트중인상품</a></li>
                ...
                <div class="container-fluid">
                    <div class="portfolio-row">
                        <div id="portfolio-item-container" class="popup-gallery max-col-4" data-layoutmode="fitRows">
                            <div class="portfolio-item snack">
                                <figure>
                                    <img src="assets/images/portfolio/grid/구운인절미.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/구운인절미.jpg" data-thumb="assets/images/portfolio/grid/구운인절미.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">구운인절미</a></h3>
                            ...
                            <div class="portfolio-item snack">
                                <figure>
                                    <img src="assets/images/portfolio/grid/더블칩.jpg" alt="Portfolio Name">
                                     <figcaption>
                                        <a href="http://www.youtube.com/watch?v=jt8YicG-F6c" data-thumb="assets/images/portfolio/grid/더블칩.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">더블칩</a></h3>
                                    <div class="portfolio-tags">
                                        <a href="#">snack</a>,
                                        <a href="#">Develop</a>
                                    </div><!-- End .portfolio-tags -->
                            ...
                            <div class="portfolio-item snack">
                                <figure>
                                    <img src="assets/images/portfolio/grid/맛동산.png" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/맛동산.png" data-thumb="assets/images/portfolio/grid/맛동산.png" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">맛동산</a></h3>
                                    <div class="portfolio-tags">
                                        <a href="#">snack</a>,
                                        <a href="#">Develop</a>
                                    </div><!-- End .portfolio-tags -->
                            ...
                            <div class="portfolio-item snack">
                                <figure>
                                    <img src="assets/images/portfolio/grid/아그칩.png" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/아그칩.png" data-thumb="assets/images/portfolio/grid/아그칩.png" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">아그칩</a></h3>
                                    <div class="portfolio-tags">
                                        <a href="#">snack</a>,
                                        <a href="#">Develop</a>
                                    </div><!-- End .portfolio-tags -->
                            ...
                            <div class="portfolio-item snack">
                                <figure>
                                    <img src="assets/images/portfolio/grid/야채타임.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/야채타임.jpg" data-thumb="assets/images/portfolio/grid/야채타임.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">야채타임</a></h3>
                                    <div class="portfolio-tags">
                                        <a href="#">snack</a>,
                                        <a href="#">Develop</a>
                                    </div><!-- End .portfolio-tags -->
                            ...
                            <div class="portfolio-item snack">
                                <figure>
                                    <img src="assets/images/portfolio/grid/에이스.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/에이스.jpg" data-thumb="assets/images/portfolio/grid/에이스.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">에이스</a></h3>
                                    <div class="portfolio-tags">
                                        <a href="#">snack</a>,
                                        <a href="#">Develop</a>
                                    </div><!-- End .portfolio-tags -->
                            ...
                            <div class="portfolio-item snack">
                                ...
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">허니버터칩</a></h3>
                                    <div class="portfolio-tags">
                                        <a href="#">snack</a>,
                                        <a href="#">Develop</a>
                                    </div><!-- End .portfolio-tags -->
                            ...
                            <div class="portfolio-item snack">
                                <figure>
                                    <img src="assets/images/portfolio/grid/타코야끼볼.jpg" alt="Portfolio Name">
                                    <figcaption>
                                        <a href="assets/images/portfolio/grid/타코야끼볼.jpg" data-thumb="assets/images/portfolio/grid/타코야끼볼.jpg" class="zoom-btn"><i class="fa fa-search"></i></a>
                                    </figcaption>
                                </figure>
                                <div class="portfolio-meta">
                                    <h3 class="portfolio-title"><a href="#" title="Portfolio name">타코야끼볼</a></h3>
                                    <div class="portfolio-tags">
                                        <a href="#">snack</a>,
                                        <a href="#">Develop</a>
                                    </div><!-- End .portfolio-tags -->
				...
				<div class="container-fluid">
                    <h2 class="title-border custom text-center mb45"><span>이번주 베스트 리뷰</span></h2>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        <h5>James Rodriguez<span>Ceo of Bold Inc.</span></h5>
                                        <figure>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        <h5>Eony James<span>Ceo of Simple</span></h5>
                                        <figure>
                ...
                <div class="mb55 mb50-sm"></div><!-- margin -->
                            ...
                            <div class="swiper-slide">
                                <article class="entry entry-grid">
                                    <div class="entry-media">
                                        <figure>
                                            <a href="single.html"><img src="assets/images/blog/yang.jpg" alt="Post image"></a>
                                        </figure>
                                    </div><!-- End .entry-media -->
                                    ...
                                    <div class="entry-content-container">
                                        ...
                                        <div class="entry-content-wrapper">
                                            <h2 class="entry-title"><a href="single.html">이것은 연양갱인가? 아이스크림인가? 해태‘연양갱바’출시</a></h2>
                                            <div class="entry-content">
                                                <p>아이스크림 냉동고에 연양갱이 들어있어도 놀라지 마시라. 해태제과(대표이사 신정훈)가 연양갱을 아이스크림으로 변신시킨 ‘연양갱바’를 출시했다. 연양갱을 차갑게 먹는 듯 달달한 팥맛에 쫀득함까지 그대로다.</p>
                            ...
                            <div class="swiper-slide">
                                <article class="entry entry-grid">
                                    ...
                                    <div class="entry-content-container">
                                        ...
                                        <div class="entry-content-wrapper">
                                            <h2 class="entry-title"><a href="single.html"></a></h2>
                                            <div class="entry-content">
