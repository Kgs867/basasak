				...
				<div id="rev_slider" class="rev_slider fullwidthabanner"
					...
					<ul>
						...
						<li data-index="rs-1" data-transition="slideoverup"
							...
							<!-- MAIN IMAGE --> <img
							src="assets/images/homepages/index/MainTest.png"
							...
							<div class="tp-caption tp-resizeme rs-parallaxlevel-0"
								...
								data-hoffset="['0','0','0','0']"
								data-y="['middle','middle','middle','middle']"
								data-voffset="['-80','-60','-50','-38']"
								data-fontsize="['220','170','150','100']" data-fontweight="700"
								data-lineheight="['220','170','150','100']" data-width="none"
								data-color="#fff" data-height="none" data-whitespace="nowrap"
							...
							<div class="tp-caption tp-resizeme rs-parallaxlevel-0"
								...
								data-hoffset="['0','0','0','0']"
								data-y="['middle','middle','middle','middle']"
								data-voffset="['35','35','35','25']" data-width="none"
								data-height="none" data-color="#fff"
								data-fontsize="['42','36','28','22']" data-fontweight="300"
								data-lineheight="['42','36','28','22']" data-whitespace="nowrap"
								data-transform_idle="o:1;"
								...
								style="z-index: 6; white-space: nowrap;">Creative &amp;
								Fresh Template</div> <!-- LAYER NR. 4 --> <a
							class="tp-caption btn btn-custom min-width tp-resizeme rs-parallaxlevel-0"
							id="slide-1-layer-4"
							data-x="['center','center','center','center']"
							data-hoffset="['-110','-100','-90','-80']"
							data-y="['middle','middle','middle','middle']"
							data-voffset="['116','106','96','75']" data-witdh="none"
							...
							data-responsive_offset="on"
							style="z-index: 6; white-space: nowrap;" href="#">See
								Features </a> <!-- LAYER NR. 5 --> <a
							class="tp-caption btn btn-custom2 min-width tp-resizeme rs-parallaxlevel-0"
							id="slide-1-layer-5"
							data-x="['center','center','center','center']"
							data-hoffset="['110','100','90','80']"
							data-y="['middle','middle','middle','middle']"
							...
							data-responsive_offset="on"
							style="z-index: 6; white-space: nowrap;" href="#">Get in
								touch </a>
						</li>
						<!-- SLIDE  -->
						<li data-index="rs-2" data-transition="slideoverdown"
							...
							<!-- MAIN IMAGE --> <img
							src="assets/images/homepages/index/slide2.jpg" alt="Slider bg 2"
				...
				<div class="row">
					<div class="col-md-3 col-sm-6">
						<div class="service">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipi sunt nisi id
								magni dignissimos rem.</p>
						</div>
						<!-- End .service -->
					</div>
					<!-- End .col-md-3 -->
				...
				<div class="portfolio-row">
					<div id="portfolio-item-container" class="popup-gallery max-col-4"
						...
						<div class="portfolio-item snack">
							<figure>
								<img src="assets/images/portfolio/grid/구운인절미.jpg"
									alt="Portfolio Name">
								<figcaption>
									<a href="assets/images/portfolio/grid/구운인절미.jpg"
										data-thumb="assets/images/portfolio/grid/구운인절미.jpg"
										class="zoom-btn"><i class="fa fa-search"></i></a>
								</figcaption>
							</figure>
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">구운인절미</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
								<!-- End .portfolio-tags -->
							</div>
							<!-- End .portfolio-meta -->
						...
						<div class="portfolio-item snack">
							<figure>
								<img src="assets/images/portfolio/grid/더블칩.jpg"
									alt="Portfolio Name">
								<figcaption>
									<a href="http://www.youtube.com/watch?v=jt8YicG-F6c"
										data-thumb="assets/images/portfolio/grid/더블칩.jpg"
										class="zoom-btn"><i class="fa fa-search"></i></a>
								</figcaption>
							</figure>
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">더블칩</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
						...
						<div class="portfolio-item snack">
							<figure>
								<img src="assets/images/portfolio/grid/맛동산.png"
									alt="Portfolio Name">
								<figcaption>
									<a href="assets/images/portfolio/grid/맛동산.png"
										data-thumb="assets/images/portfolio/grid/맛동산.png"
										class="zoom-btn"><i class="fa fa-search"></i></a>
								</figcaption>
							</figure>
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">맛동산</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
						...
						<div class="portfolio-item snack">
							...
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">아그칩</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
						...
						<div class="portfolio-item snack">
							<figure>
								<img src="assets/images/portfolio/grid/야채타임.jpg"
									alt="Portfolio Name">
								<figcaption>
									<a href="assets/images/portfolio/grid/야채타임.jpg"
										data-thumb="assets/images/portfolio/grid/야채타임.jpg"
										class="zoom-btn"><i class="fa fa-search"></i></a>
								</figcaption>
							</figure>
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">야채타임</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
						...
						<div class="portfolio-item snack">
							<figure>
								<img src="assets/images/portfolio/grid/에이스.jpg"
									alt="Portfolio Name">
								<figcaption>
									<a href="assets/images/portfolio/grid/에이스.jpg"
										data-thumb="assets/images/portfolio/grid/에이스.jpg"
										class="zoom-btn"><i class="fa fa-search"></i></a>
								</figcaption>
							</figure>
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">에이스</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
						...
						<div class="portfolio-item snack">
							...
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">허니버터칩</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
						...
						<div class="portfolio-item snack">
							<figure>
								<img src="assets/images/portfolio/grid/타코야끼볼.jpg"
									alt="Portfolio Name">
								<figcaption>
									<a href="assets/images/portfolio/grid/타코야끼볼.jpg"
										data-thumb="assets/images/portfolio/grid/타코야끼볼.jpg"
										class="zoom-btn"><i class="fa fa-search"></i></a>
								</figcaption>
							</figure>
							<div class="portfolio-meta">
								<h3 class="portfolio-title">
									<a href="#" title="Portfolio name">타코야끼볼</a>
								</h3>
								<div class="portfolio-tags">
									<a href="#">snack</a>, <a href="#">Develop</a>
								</div>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="testimonial-box">
								...
								<div class="testimonial-owner">
									<h5>
										Jason Richardson<span>Ceo of Boss Inc.</span>
									</h5>
									<figure>
						...
						<div class="swiper-slide">
							<div class="testimonial-box">
								...
								<div class="testimonial-owner">
									<h5>
										Eon Dean<span>Ceo of Eonythemes</span>
									</h5>
									<figure>
								...
								<div class="entry-media">
									<figure>
										<a href="single.html"><img
											src="assets/images/blog/yang.jpg" alt="Post image"></a>
									</figure>
								</div>
								<!-- End .entry-media -->
								...
								<div class="entry-content-container">
									...
									<div class="entry-content-wrapper">
										<h2 class="entry-title">
											<a href="single.html">이것은 연양갱인가? 아이스크림인가? 해태‘연양갱바’출시</a>
										</h2>
										<div class="entry-content">
											<p>아이스크림 냉동고에 연양갱이 들어있어도 놀라지 마시라. 해태제과(대표이사 신정훈)가 연양갱을
												아이스크림으로 변신시킨 ‘연양갱바’를 출시했다. 연양갱을 차갑게 먹는 듯 달달한 팥맛에 쫀득함까지 그대로다.</p>
									...
									<figure id="blog-post-gallery" class="carousel slide"
										...
										<div class="carousel-inner">
											<div class="item active">
												<a href="single.html"><img
													src="assets/images/blog/post2.jpg" alt="Post image"></a>
											</div>
											<!-- End .item -->

											<div class="item">
												<a href="single.html"><img
													src="assets/images/blog/post3.jpg" alt="Post image"></a>
											</div>
											<!-- End .item -->
										</div>
										<!-- End .carousel-inner -->
						...
						<div class="swiper-slide">
							<article class="entry entry-grid">
								<div class="entry-media">
									<figure>
										<a href="single.html"><img
											src="assets/images/blog/post4.jpg" alt="Post image"></a>
									</figure>
								</div>
								<!-- End .entry-media -->
						...
						<div class="swiper-slide">
							<article class="entry entry-grid">
								<div class="entry-media">
									<figure>
										<a href="single.html"><img
											src="assets/images/blog/post5.jpg" alt="Post image"></a>
									</figure>
								</div>
								<!-- End .entry-media -->
